...
Настоящият проект **Developing Cross-Platform Apps** представя Microsoft технологиите за разработка на **Универсални Windows приложения (UWP)**, **Mултиплатформени мобилни приложения с Xamarin.Forms** и **Потребителски интерфейс на мултиплатформени приложения с MAUI**.
