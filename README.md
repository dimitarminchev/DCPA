# Разработка на мултиплатформени приложения
Настоящият проект **Developing Cross-Platform Apps** представя Microsoft технологиите за разработка на мултиплатформени приложения.
