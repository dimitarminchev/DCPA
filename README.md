...
Настоящият проект представя Microsoft технологиите за разработка на **Универсални Windows приложения** (UWP), **Mултиплатформени мобилни приложения** (Xamarin.Forms) и **Потребителски интерфейс на мултиплатформени приложения** (MAUI).
