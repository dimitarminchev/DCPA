...
Регистрацията като разработчик на приложения в центъра за разработчици се заплаща с еднократна такса в американски долара, която е различна за индивидуални потребители и корпоративни клиенти. 

![](/images/117_Microsoft_Partner_Center.png)

_Фиг. 1.17. Център за разработчици на Microsoft_
