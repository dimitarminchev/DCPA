...
# Актуализация за добавяне на хипер-връзки
Документация: [Xamarin.Forms Hyperlinks Microsoft Docs](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/text/label#hyperlinks)
...
```
В началото на страницата към ContentPage добавете следното:
```
